...
base by: @shahanurrhmn
created by: @shahanurrhmn
...
async def _(event):
    ...
    if reply_message.sender.bot:
       ...
       await event.edit("``` Wait please ! Memifying this image!```")
    ...
    async with borg.conversation("@MemeAutobot") as bot_conv:
          ...
          if "Okay..." in response.text:
            ...
            await borg.send_file(  # pylint:disable=E0602
                ...
                # Courtesy: @shahanurrhmn
            )
            await event.delete()
            sax = await borg.send_message(event.chat_id, " 'powered by @shahanurrhmn 🔥🔥`")
